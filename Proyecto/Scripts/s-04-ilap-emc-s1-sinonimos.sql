...
--@Descripción:     Sinonimos nodo F1

--Sucursal
create or replace synonym sucursal_f1 for sucursal_f1_emc_s1;
...
--Sucursal Taller
create or replace synonym sucursal_taller_f1 for sucursal_taller_f1_emc_s1;
...
--Sucursal Venta
create or replace synonym sucursal_venta_f1 for sucursal_venta_f1_emc_s1;
...
--Tipo Procesador
create or replace synonym tipo_procesador_r1 for tipo_procesador_r_emc_s1;
...
--Tipo Tarjeta Video
create or replace synonym tipo_tarjeta_video_r1 for tipo_tarjeta_video_r_emc_s1;
...
--Tipo Almacenamiento
create or replace synonym tipo_almacenamiento_r1 for tipo_almacenamiento_r_emc_s1;
...
--Tipo Monitor
create or replace synonym tipo_monitor_r1 for tipo_monitor_r_emc_s1;
...
create or replace synonym laptop_f2 for laptop_f2_emc_s1;
...
--Servicio Laptop
create or replace synonym servicio_laptop_f1 for servicio_laptop_f1_emc_s1;
...
create or replace synonym historico_status_laptop_f1 for historico_status_laptop_f1_emc_s1;
