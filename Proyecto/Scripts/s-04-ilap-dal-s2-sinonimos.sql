...
create or replace synonym sucursal_f4 for sucursal_f4_dal_s2;
...
create or replace synonym sucursal_taller_f4 for sucursal_taller_f4_dal_s2;
...
create or replace synonym sucursal_venta_f4 for sucursal_venta_f4_dal_s2;
...
create or replace synonym tipo_procesador_r4 for tipo_procesador_r_dal_s2;
...
create or replace synonym tipo_tarjeta_video_r4 for tipo_tarjeta_video_r_dal_s2;
...
create or replace synonym tipo_almacenamiento_r4 for tipo_almacenamiento_r_dal_s2;
...
create or replace synonym tipo_monitor_r4 for tipo_monitor_r_dal_s2;

--Laptop
create or replace synonym laptop_f1 for laptop_f1_dal_s2;
...
create or replace synonym laptop_f5 for laptop_f5_dal_s2;
...
create or replace synonym servicio_laptop_f4 for servicio_laptop_f4_dal_s2;
